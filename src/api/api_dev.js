...
const API = {
  ...
  // 审核流程
  REVIEW_PROCESS_URL: 'http://sso01.xiamenair.com.cn/bpm/sys/lbpmdocking/lbpm_docking_main/lbpmDockingMain.do', // 页面地址
  REVIEW_PROCESS_SUBMINT: 'Template/ApproveNode', // 提交数据地址

  // 文件处理
  UPLOAD_FILE_URL: 'http://localhost:60787/api/Upload/SaveFilesToServer', // 文件上传接口
  ...
  COMMON_MODEL_TYPE: [
    ...
    {url: 'continuousMonitoringPlanApprovalLink', value: '7CCD7CE1-B154-45F8-A0BA-BAFD7A63B6FE', name: '持续监控计划 '},
