<template>
  <div class="height-100 oneKeyRegister">
    <M-Table-List >
      <div slot="Info">
      ...
      <div slot="TableDom">
        <el-table :data="tableData"  :stripe="true"  style="width: 100%;" border ref="xzTable" :height="sHeight">
          ...
          <el-table-column prop="createTime" label="提交日期" min-width="150" align="center" :formatter="dateFormat">
          </el-table-column>
          <el-table-column prop="errMsg" label="注册失败原因" min-width="150" align="center">
          </el-table-column>
          <el-table-column prop="isRegistered" label="是否已注册" min-width="150" align="center" :formatter="isRegistered">
          </el-table-column>
